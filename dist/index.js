...
function viewEmployees() {
    pool.query(`SELECT employee.id, employee.first_name, employee.last_name, role.title, department.name AS department, role.salary, CONCAT(manager.first_name, ' ', manager.last_name) AS manager
     ...
     LEFT JOIN employee AS manager ON employee.manager_id = manager.id`, (error, results) => {
        if (error) {
...
function addDepartment() {
    inquirer
        ...
        pool.query('INSERT INTO department (name) VALUES ($1)', [departmentName], (error) => {
            if (error) {
...
function addRole() {
    pool.query('SELECT * FROM department', (error, results) => {
        ...
        inquirer
            ...
            pool.query('INSERT INTO role (title, salary, department_id) VALUES ($1, $2, $3)', [roleTitle, roleSalary, departmentId], (error) => {
                if (error) {
    ...
    pool.query('SELECT * FROM role', (error, results) => {
        ...
        pool.query('SELECT * FROM employee', (error, results) => {
            ...
            inquirer
                ...
                pool.query('INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4)', [firstName, lastName, roleId, managerId], (error) => {
                    if (error) {
    ...
    pool.query('SELECT * FROM employee', (error, results) => {
        ...
        pool.query('SELECT * FROM role', (error, results) => {
            ...
            inquirer
                ...
                pool.query('UPDATE employee SET role_id = $1 WHERE id = $2', [roleId, employeeId], (error) => {
                    if (error) {
